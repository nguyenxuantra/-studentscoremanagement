<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        if(isset($_POST['update']))
        {
            ...
            $ten_mh = $_POST['ten_mh'];
            $so_tin = $_POST['so_tin'];
            $sql = "update monhoc set id_mh=:id_mh, ten_mh=:ten_mh, so_tin=:so_tin Where id_mh=:id_mh";
            $statement=$conn->prepare($sql);
            $data=[
                "id_mh"=>$id_mh,
                "ten_mh"=> $ten_mh,
        ...
        <?php 
            foreach($statement as $row) { ?>
                <form action="" method="post">
                  ...
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Tên môn học</label>
                    <input class="form-control col-sm-4" type="text" name="ten_mh" value=" <?php echo $row['ten_mh'];?>"><br>
                  </div>
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Số tín</label>
                    <input class="form-control col-sm-4" type="text" name="so_tin" value="<?php echo $row['so_tin'];?>"> <br>
                  </div>
