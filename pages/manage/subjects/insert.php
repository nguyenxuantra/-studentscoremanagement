<?php 
    ...
    if(isset($_POST["them"]))
    {
        $sql = "insert into monhoc values (:id_mh,:ten_mh,:so_tin)";
        ...
        <div class="main-panel">
          <form action="" method="post">
            ...
            <div class="mb-3 row">
              ...
              <input class="form-control col-sm-4" type="text" name="ten_mh"><br>     
            </div>
            <div class="mb-3 row">
              <label class="form-label col-sm-2" for="">Số tín</label>
              <input class="form-control col-sm-4" type="text" name="so_tin"><br>      
            </div>
