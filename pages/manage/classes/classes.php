...
require_once "../../../connection/connect.php";
    ...
    if(isset($_POST['btn_search'])) {
        ...
        if($search == "") {
            if($id_khoa!="Mã khoa")
            {
              $sql_search = "SELECT * FROM lop WHERE id_khoa=$id_khoa";
              ...
              if($row_count_search > 0) {
                  ...
                  echo "<thead><tr><th>Id lop</th><th>id khoa</th><th>Tên lớp</th><th><a class='btn btn-primary' href='insert.php'>Thêm</a></th></tr></thead><tbody>";
                  foreach($statement_search as $row) {
                      echo "<tr>";
                      echo "<th>{$row['id_lop']}</th>";
                      echo "<th>{$row['id_khoa']}</th>";
                      echo "<th>{$row['ten_lop']}</th>";
                      echo "<th><a class='btn btn-warning' href='delete.php?id={$row['id_lop']}'>Xóa</a> &nbsp;<a class='btn btn-warning' href='update.php?id={$row['id_lop']}'>Sửa</a></th>";
                      echo "</tr>";
                  }
                  echo "</tbody></table>";
            } else {
            ...
            $sql_search = "SELECT * FROM lop WHERE id_lop LIKE '%$search%' OR id_khoa LIKE '%$search%' OR ten_lop LIKE '%$search%'";
            $statement_search = $conn->query($sql_search);
