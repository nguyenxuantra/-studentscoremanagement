<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        if(isset($_POST['update']))
        {
            ...
            $sql = "update lop set id_lop=:id_lop, id_khoa=:id_khoa, ten_lop=:ten_lop Where id_lop=:id_lop";
            $statement=$conn->prepare($sql);
            $data=[
                "id_lop"=>$id_lop,
                "id_khoa"=> $id_khoa,
        ...
        <?php 
            foreach($statement as $row) { ?>
                <form action="" method="post">
                  ...
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Tên lớp</label>
                    <input class="form-control col-sm-4" type="text" name="ten_lop" value="<?php echo $row['ten_lop'];?>"> <br>
                  </div> 
