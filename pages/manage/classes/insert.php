<?php 
    ...
    if(isset($_POST["them"]))
    {
        $sql = "insert into lop values (:Id_lop,:Id_khoa,:ten_lop)";
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <form action="" method="post">
            <div class="mb-3 row">
              <label class="form-label col-sm-2" for="">ID_LOP</label>
              <input class="form-control col-sm-4" type="text" name="Id_lop"><br>
            </div>
            <div class="mb-3 row">
              <label class="form-label col-sm-2" for="">Id_khoa</label>
              <input class="form-control col-sm-4" type="text" name="Id_khoa"><br>             
            </div>
            <div class="mb-3 row">
              <label class="form-label col-sm-2"  for="">Ten lớp</label>
              <input class="form-control col-sm-4" type="text" name="ten_lop"><br>
            </div>    
