<?php 
    ...
    if(isset($_POST["them"]))
    {
        $sql = "insert into sinhvien values (:id_sv,:id_lop,:id_cn,:id_khoa,:ho_ten,:que_quan,:ngay_sinh)";
        ...
        <div class="main-panel">
          <form action="" method="post">
            <div class="mb-1 row">
              ...
              <input class="form-control col-sm-4" type="text" name="id_sv"><br>
            </div>
            <div class="mb-1 row">
              <label class="form-label col-sm-2" for="">Id Lớp</label>
              <input class="form-control col-sm-4" type="text" name="id_lop"><br> 
            </div>
            <div class="mb-1 row">
              <label class="form-label col-sm-2" for="">Id Chuyên Ngành</label>
              <input class="form-control col-sm-4" type="text" name="id_cn"><br> 
            </div>
            <div class="mb-1 row">
              <label class="form-label col-sm-2" for="">Id Khoa</label>
              <input class="form-control col-sm-4" type="text" name="id_khoa"><br> 
            </div>
            <div class="mb-1 row">
            ...
            <div class="mb-1 row">
              ...
              <input class="form-control col-sm-4" type="text" name="ngay_sinh"><br>
            </div>
            <button class="btn btn-primary" type="submit" name="them">Thêm</button>
          </form>
        </div>
        <!-- main-panel ends -->
      </div>
