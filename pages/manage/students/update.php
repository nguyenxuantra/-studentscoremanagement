<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        if(isset($_POST['update']))
        {
            ...
            $ho_ten = $_POST['ho_ten'];
            $ngay_sinh = $_POST['que_quan'];
            $que_quan = $_POST['ngay_sinh'];
            $sql = "update sinhvien set id_sv=:id_sv, id_lop=:id_lop,id_cn=:id_cn, id_khoa=:id_khoa, ho_ten=:ho_ten, que_quan=:que_quan, ngay_sinh=:ngay_sinh Where id_sv=:id_sv";
            $statement=$conn->prepare($sql);
            $data=[
              'id_sv' => $id_sv,
              'id_lop' =>$id_lop,
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <?php 
            foreach($statement as $row) { ?>
                <form action="" method="post">
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Id sinh viên</label>
                    <input class="form-control col-sm-4" type="text" name="id_sv" value="<?php echo $row['id_sv'];?>"><br>
                  </div>
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Id lop</label>
                    <input class="form-control col-sm-4" type="text" name="id_lop" value=" <?php echo $row['id_lop'];?>"><br>                  
                  </div>
                  <div class="mb-1 row">
                    <label class="form-label col-sm-2" for="">Id Chuyên Ngành</label>
                    <input class="form-control col-sm-4" type="text" name="id_cn" value=" <?php echo $row['id_cn'];?>"><br> 
                  </div>
                  <div class="mb-1 row">
                    <label class="form-label col-sm-2" for="">Id Khoa</label>
                    <input class="form-control col-sm-4" type="text" name="id_khoa" value=" <?php echo $row['id_khoa'];?>"><br> 
                  </div>
                  <div class="mb-3 row">
                  ...
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Ngày sinh</label>
                    <input class="form-control col-sm-4" type="text" name="ngay_sinh" value="<?php echo $row['ngay_sinh'];?>"> <br>                 
                  </div>
