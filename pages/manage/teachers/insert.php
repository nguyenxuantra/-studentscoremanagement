<?php 
    ...
    if(isset($_POST["them"]))
    {
        $sql = "insert into giangvien values (:id_gv,:id_khoa,:ho_ten,:que_quan,:ngay_sinh)";
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <form action="" method="post">
            <div class="mb-3 row">
              <label class="form-label col-sm-2" for="">ID giảng viên</label>
              <input class="form-control col-sm-4" type="text" name="id_gv"><br>
            </div>
            <div class="mb-3 row">
