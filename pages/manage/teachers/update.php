<?php 
    ...
    {
        $id= $_GET['id'];
        $sql = "select * from giangvien where id_gv=:id_gv";
        ...
        if(isset($_POST['update']))
        {
            ...
            $sql = "update giangvien set id_gv=:id_gv, id_khoa=:id_khoa, ho_ten=:ho_ten, que_quan=:que_quan, ngay_sinh=:ngay_sinh Where id_gv=:id_gv";
            $statement=$conn->prepare($sql);
            $data=[
              'id_gv' => $id_gv,
              'id_khoa' =>$id_khoa,
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <?php 
            foreach($statement as $row) { ?>
                <form action="" method="post">
                  <div class="mb-3 row">
                    <label for="" class="form-label col-sm-2">Id giang viên</label>
                    <input type="text" name="id_gv" class="form-control col-sm-4" value="<?php echo $row['id_gv'];?>"><br>
                  </div>
                  <div class="mb-3 row">
                  ...
                  <div class="mb-3 row">
                    ...
                    <button class="btn-primary" type="submit" name="update">Sửa</button>
                </form>
    <?php } ?>
        </div>
        <!-- main-panel ends -->
