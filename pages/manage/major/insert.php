<?php 
    ...
    if(isset($_POST["them"]))
    {
        $sql = "insert into chuyennganh values (:id_cn,:ten_cn,:khoa)";
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <form action="" method="post">
            <div class="mb-3 row">
              <label class="form-label col-sm-2" for="">ID_CN</label>
              <input class="form-control col-sm-4" type="text" name="id_cn"><br>
            </div>
            <div class="mb-3 row">
              <label class="form-label col-sm-2" for="">Tên chuyên ngành</label>
              <input class="form-control col-sm-4" type="text" name="ten_cn"><br>             
            </div>
            <div class="mb-3 row">
              <label class="form-label col-sm-2"  for="">Khoa</label>
              <input class="form-control col-sm-4" type="text" name="khoa"><br>
            </div>    
