<?php 
    ...
    {
        $id= $_GET['id'];
        $sql = "select * from chuyennganh where id_cn=:id_cn";
        ...
        if(isset($_POST['update']))
        {
            ...
            $ten_cn = $_POST['ten_cn'];
            $khoa = $_POST['khoa'];
            $sql = "update chuyennganh set id_cn=:id_cn, ten_cn=:ten_cn, khoa=:khoa Where id_cn=:id_cn";
            $statement=$conn->prepare($sql);
            $data=[
                "id_cn"=>$id_cn,
                "ten_cn"=> $ten_cn,
        ...
        <?php 
            foreach($statement as $row) { ?>
                <form action="" method="post">
                  ...
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Tên chuyên ngành</label>
                    <input class="form-control col-sm-4" type="text" name="ten_cn" value=" <?php echo $row['ten_cn'];?>"><br>
                  </div>
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Khoa</label>
                    <input class="form-control col-sm-4" type="text" name="khoa" value="<?php echo $row['khoa'];?>"> <br>
                  </div> 
