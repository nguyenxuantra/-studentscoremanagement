<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        if(isset($_POST['update']))
        {
            $id_sv= $_POST['id_sv'];
            $id_mh = $_POST['id_mh'];
            $diem_tp = $_POST['diem_tp'];
            $diem_thi = $_POST['diem_thi'];
            $diem_tb = $_POST['diem_tb'];
            $xep_loai = $_POST['xep_loai'];
            $sql = "update diem set id_sv=:id_sv, id_mh=:id_mh, diem_tp=:diem_tp,diem_thi=:diem_thi, diem_tb=:diem_tb, xep_loai=:xep_loai Where id=:id ";
            $statement=$conn->prepare($sql);
            $data=[
                "id_sv"=>$id_sv,
                "id_mh"=> $id_mh,
        ...
        <?php 
            foreach($statement as $row) { ?>
                <form action="" method="post">
                  ...
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Id môn học</label>
                    <input class="form-control col-sm-4" type="text" name="id_mh" value=" <?php echo $row['id_mh'];?>"><br> 
                  </div>
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Điểm Thành Phân</label>
                    <input class="form-control col-sm-4" type="text" name="diem_tp" value="<?php echo $row['diem_tp'];?>"> <br>  
                  </div>
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Điểm thi</label>
                    <input class="form-control col-sm-4" type="text" name="diem_thi" value="<?php echo $row['diem_thi'];?>"> <br>    
                  </div>
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Điểm trung bình</label>
                    <input class="form-control col-sm-4" type="text" name="diem_tb" value="<?php echo $row['diem_tb'];?>"> <br>    
                  </div>
                  <div class="mb-3 row">
                    <label class="form-label col-sm-2" for="">Xếp loại</label>
                    <input class="form-control col-sm-4" type="text" name="xep_loai" value="<?php echo $row['xep_loai'];?>"> <br>    
                  </div>
