<?php 
    ...
    if(isset($_POST["them"]))
    {
      $sql = "INSERT INTO diem (id_sv, id_mh, diem_tp, diem_thi,diem_tb,xep_loai) VALUES (:id_sv, :id_mh, :diem_tp, :diem_thi,:diem_tb,:xep_loai)";
        ...
        <div class="main-panel">
          <form action="" method="post">
            ...
            <div class="mb-3 row">
              ...
              <input class="form-control col-sm-4" type="text" name="id_mh"><br>         
            </div>
            <div class="mb-3 row">
              <label class="form-label col-sm-2" for="">Điểm thành phần</label>
              <input class="form-control col-sm-4" type="text" name="diem_tp"><br>              
            </div>
            <div class="mb-3 row">
              <label class="form-label col-sm-2" for="">Điểm thi</label>
              <input class="form-control col-sm-4" type="text" name="diem_thi"><br>            
            </div>
            <div class="mb-3 row">
              <label class="form-label col-sm-2" for="">Điểm trung bình</label>
              <input class="form-control col-sm-4" type="text" name="diem_tb"><br>            
            </div>
            <div class="mb-3 row">
              <label class="form-label col-sm-2" for="">Xếp loại</label>
              <input class="form-control col-sm-4" type="text" name="xep_loai"><br>            
            </div>
