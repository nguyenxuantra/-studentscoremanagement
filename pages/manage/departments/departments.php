...
<?php
        ...
        if (isset($_POST['btn_search'])) {
            ...
            if ($search == "") {
                ...
                $sql_search = "SELECT * FROM khoa WHERE 
                    ten_khoa LIKE '%$search%' ";
                ...
                if ($row_count_search > 0) {
                    echo "Tìm thấy kết quả:".'<div class="row d-flex justify-content-end"><a href="departments.php" class="btn btn-primary mt-1 mb-2 mr-3 ">Trở lại</a></div>';
                    // Hiển thị kết quả tìm kiếm
                    echo "<table class='table table-dark table-hover'>";
                    echo "<thead><tr><th>Id</th><th>Tên khoa</th><th>Action</th></tr></thead><tbody>";
                    foreach ($statement_search as $row) {
                        echo "<tr>";
                        echo "<th>{$row['id_khoa']}</th>";
                        echo "<th>{$row['ten_khoa']}</th>";
                        echo "<th><a class='btn btn-warning' href='delete.php?id={$row['id_khoa']}'>Xóa</a> &nbsp;<a class='btn btn-warning' href='update.php?id={$row['id_khoa']}'>Sửa</a></th>";
                        echo "</tr>";
                    }
                    echo "</tbody></table>";
                } else {
            ...
            $sql_all = "SELECT * FROM khoa";
            $statement_all = $conn->query($sql_all);
            echo "Danh sách Khoa:";
            echo "<table class='table table-dark table-hover'>";
            echo "<thead><tr><th>Id khoa</th><th>Tên khoa</th><th><a class='btn btn-primary' href='insert.php'>Thêm</a></th></tr></thead><tbody>";
