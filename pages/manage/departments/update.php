<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        if(isset($_POST['update']))
        {
            ...
            $sql = "update khoa set id_khoa=:id_khoa, ten_khoa=:ten_khoa Where id_khoa=:id_khoa";
            $statement=$conn->prepare($sql);
            $data=[
                "id_khoa"=>$id_khoa,
                "ten_khoa"=> $ten_khoa,
            ...
            foreach($statement as $row) { ?>
                <form action="" method="post">
                  ...
                  <div class="mb-3 row">
                    ...
                    <input class="form-control col-sm-4" type="text" name="ten_khoa" value=" <?php echo $row['ten_khoa'];?>"><br>
                  </div>
