      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <form action="" method="post">
            ...
            <div class="mb-3 row">
              <label class="form-label col-sm-2" for="">Tên khoa</label>
              <input class="form-control col-sm-4" type="text" name="ten_khoa"><br>
            </div>
